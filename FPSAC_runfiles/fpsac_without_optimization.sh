...
python2 src/fpsac_format_blast_hits.py \
    ${MEGABLAST_HITS} \
...
python2 src/fpsac_compute_families_coordinates_and_profiles.py \
    ${ANCIENT_EXTANT_HITS} \
    ${FAMILIES_COORDINATES_ALL}_1 \
    ${FAMILIES_PROFILES_ALL}_1 \
    ${LG_THRESHOLD} \
    ${SIM_THRESHOLD}
python2 src/fpsac_correct_families.py \
     ${FAMILIES_COORDINATES_ALL}_1 \
     ${FAMILIES_PROFILES_ALL}_1 \
...
python2 src/fpsac_compute_families_ancestral_content.py \
    $TREE \
    ${FAMILIES_PROFILES_ALL} \
...
python2 src/fpsac_filter_families.py \
    ${FAMILIES_COORDINATES_ALL} \
    ${FAMILIES_ANCESTRAL_CONTENT} \
    ${MULT_THRESHOLD} \
...
python2 src/fpsac_double_markers.py \
    ${FAMILIES_COORDINATES_FILTERED_UNI} \
...
python2 src/fpsac_compute_conserved_syntenies.py \
    ${FAMILIES_COORDINATES_FILTERED_DOUBLED} \
    ${FAMILIES_ANCESTRAL_CONTENT} \
    $SPECIES \
    ${SPECIES_PAIRS} \
...
python2 src/fpsac_weight.py \
    ...
    ${RSI_WGTD}_tmp \
    d
python2 src/fpsac_correct_weighted_repeat_spanning_intervals.py \
    ${RSI_WGTD}_tmp \
    ${RSI_ALL} \
    ${RSI_WGTD}
rm -f  ${RSI_WGTD}_tmp
...
python2 src/fpsac_filter_adjacencies.py \
    ${ADJACENCIES_WGTD} \
    ${FAMILIES_ANCESTRAL_CONTENT} \
    1 \
    ${ADJACENCIES_KEPT} \
...
python2 src/fpsac_filter_repeat_spanning_intervals.py \
    ${RSI_WGTD} \
    ${ADJACENCIES_KEPT} \
    ${FAMILIES_ANCESTRAL_CONTENT} \
    ${RSI_KEPT} \
...
#python2 src/fpsac_compute_cars_adjacencies.py \
#    ${FAMILIES_COORDINATES_FILTERED_DOUBLED} \
#    ${SCAFFOLD_ORDER_DOUBLED} \
#    $SPECIES \
#    1 \
...
#python2 src/fpsac_compute_repeat_clusters.py \
#    ${ADJACENCIES_ALL} \
#    ${FAMILIES_ANCESTRAL_CONTENT} \
#    ${REPEAT_CLUSTERS}
...
python2 src/fpsac_extract_gaps.py \
    ${ADJACENCIES_ALL} \
    ${RSI_KEPT} \
    ${FAMILIES_ANCESTRAL_CONTENT} \
    ${GAPS_COORDINATES}
...
python2 src/fpsac_compute_supported_gaps.py \
    ${GAPS_COORDINATES} \
    ${SPECIES_PAIRS} \
    1 0 \
    ${GAPS_COORDINATES_LG}
...
#python2 src/fpsac_extract_extant_gaps_sequences.py \
#    ${EXTANT_GENOMES_FA} \
#    ${GAPS_COORDINATES_LG} \
#    ${FINISHING_ALG}/
...
python2 src/fpsac_extract_families_sequences.py \
    ${FAMILIES_COORDINATES_ALL} \
